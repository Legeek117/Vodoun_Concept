            ...
            <div className="max-w-7xl mx-auto px-[5vw]">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-4 mb-8">
                            <a
                                href="https://www.instagram.com/vodun.concept.store"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-ivoire/80 text-sm uppercase tracking-[0.3em] hover:text-or transition-colors"
                            >
                                Instagram
                            </a>
                            <a
                                href="https://www.facebook.com/vodunconceptstore"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-ivoire/80 text-sm uppercase tracking-[0.3em] hover:text-or transition-colors"
                            >
                            ...
                            <a
                                href="https://www.linkedin.com/company/vodun-concept-store"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-ivoire/80 text-sm uppercase tracking-[0.3em] hover:text-or transition-colors"
                            >
                ...
                <div className="pt-8 border-t border-ivoire/10 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center">
                        ...
                        <Link to="/confidentialite" className="text-ivoire/40 text-xs uppercase tracking-[0.2em] hover:text-or transition-colors text-center">{t.footer.privacy}</Link>
                    </div>
                </div>
            </div>
        </footer>
